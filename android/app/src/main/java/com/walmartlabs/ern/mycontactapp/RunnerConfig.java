package com.walmartlabs.ern.mycontactapp;

import com.walmartlabs.ern.container.miniapps.MyContactAppActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = MyContactAppActivity.class;
